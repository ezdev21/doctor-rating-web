...
<div>
  ...
  <div class="lg:flex w-3/4 m-auto">
  <div v-if="doctors.length" class="w-3/4">
    <div v-for="doctor in filteredDoctors" :key="doctor.id" class="shadow-xl m-3 rounded-xl p-1">
    <a :href="`/doctor/profile/${doctor.id}`" class="flex">
      <img :src="`/storage/doctors/${doctor.avatar}`" class="w-32 h-32 rounded-full m-1">
  ...
  <div v-if="doctors.length" class="w-1/3 text-xl mx-5">
   <div class="my-3 border-2 border-gray-400 rounded-xl py-3 px-10">
    <h2 class="text-base lg:text-2xl font-bold mx-1">Sort</h2>
   ...
   <div class="my-3 border-2 border-gray-400 rounded-xl py-3 px-10">
    <h2 class="text-base lg:text-2xl font-bold mx-1">Gender</h2>
    <p><input @change="filterdoctors" type="radio" v-model="gender" value="male" name="gender" class="m-1 form-radio text-tiruhakim border-2 border-tiruhakim h-8 w-8">male</p>
   ...
   <div class="my-3 border-2 border-gray-400 rounded-xl py-3 px-10">
    <h2 class="text-base lg:text-2xl font-bold mx-1">Age</h2>
    <p><input @change="filterdoctors" type="radio" v-model="age" value="under40" name="age" class="m-1 form-radio text-tiruhakim border-2 border-tiruhakim h-8 w-8">under 40</p>
